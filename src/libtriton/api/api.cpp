...
namespace triton {
  ...
  bool API::taintMemory(const triton::arch::MemoryAccess& mem, triton::engines::taint::Tag * const tag) {
    this->checkTaint();
  ...
  bool API::taintRegister(const triton::arch::Register& reg, triton::engines::taint::Tag * const tag) {
    this->checkTaint();
