...
namespace triton {
  ...
  bool API::taintMemory(const triton::arch::MemoryAccess& mem, const std::shared_ptr<triton::engines::taint::Tag>& tag) {
    this->checkTaint();
  ...
  bool API::taintRegister(const triton::arch::Register& reg, const std::shared_ptr<triton::engines::taint::Tag>& tag) {
    this->checkTaint();
  ...
  std::set<std::shared_ptr<triton::engines::taint::Tag>> API::getTagsOnRegister(const triton::arch::Register& reg) {
    this->checkTaint();
    return this->taint->getTags(reg);
  }


  std::set<std::shared_ptr<triton::engines::taint::Tag>> API::getTagsOnMemoryAccess(const triton::arch::MemoryAccess& mem) {
    this->checkTaint();
    return this->taint->getTags(mem);
  }


  bool API::removeTagOnRegister(const triton::arch::Register& reg, const std::shared_ptr<triton::engines::taint::Tag>& tag) {
    this->taint->removeTag(reg, tag);
    return this->taint->isRegisterTainted(reg);
  }

  bool API::removeTagOnMemory(const triton::arch::MemoryAccess& mem, const std::shared_ptr<triton::engines::taint::Tag>& tag) {
