 ...
 */
    ...
    class API {
      ...
      public:
        ...
        bool taintMemory(const triton::arch::MemoryAccess& mem, triton::engines::taint::Tag * const tag);
        ...
        bool taintRegister(const triton::arch::Register& reg, triton::engines::taint::Tag * const tag);
